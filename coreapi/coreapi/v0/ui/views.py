...
#    def get(self, request, format=None):
#        flat_types = request.query_params.getlist('flat',None)
#        society_type = request.query_params.getlist('society',None)
#        campaign_type = request.query_params.get('campaign',None).split()
