...
from .views import (SupplierType, SupplierTypeById, Supplier, SupplierById,SupplierTypeSociety, ShortlistedSpacesTransfer)
...
urlpatterns = [
    ...
    url(r'^societies-add/$', SupplierTypeSociety.as_view()),
