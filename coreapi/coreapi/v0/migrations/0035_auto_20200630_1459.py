# Generated by Django 2.1.4 on 2020-06-30 09:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('code', models.CharField(max_length=255)),
                ('booking_status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booking_substatus', to='v0.BookingStatus')),
            ],
            options={
