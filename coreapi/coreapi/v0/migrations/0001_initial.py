    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_confidence', models.CharField(max_length=30, null=True, db_column='PRICE_CONFIDENCE', blank=True)),
                ...
                ('last_meeting_date', models.CharField(max_length=30, null=True, db_column='LAST_MEETING_DATE', blank=True)),
                ('last_remarks', models.CharField(max_length=30, null=True, db_column='LAST_REMARKS', blank=True)),
