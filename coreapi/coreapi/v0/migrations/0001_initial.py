    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adinventory_name', models.CharField(default='PO', max_length=2, db_column='ADINVENTORY_NAME', choices=[('PO', 'Poster'), ('SD', 'Standee'), ('ST', 'Stall'), ('BA', 'Banner')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner_weekly_price_society', models.CharField(max_length=5, null=True, db_column='BANNER_WEEKLY_PRICE_SOCIETY', blank=True)),
                ('banner_monthly_price_society', models.CharField(max_length=5, null=True, db_column='BANNER_MONTHLY_PRICE_SOCIETY', blank=True)),
                ('banner_weekly_price_business', models.CharField(max_length=5, null=True, db_column='BANNER_WEEKLY_PRICE_BUSINESS', blank=True)),
                ('banner_monthly_price_business', models.CharField(max_length=5, null=True, db_column='BANNER_MONTHLY_PRICE_BUSINESS', blank=True)),
                ('inventory_status', models.CharField(max_length=15, db_column='INVENTORY_STATUS')),
                ('event_id', models.CharField(max_length=20, null=True, db_column='EVENT_ID', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_daily_price_society', models.CharField(max_length=20, null=True, db_column='CAR_DAILY_PRICE_SOCIETY', blank=True)),
                ('car_daily_price_business', models.CharField(max_length=20, null=True, db_column='CAR_DAILY_PRICE_BUSINESS', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True, db_column='ID')),
                ('size_length', models.CharField(max_length=10, null=True, db_column='SIZE_LENGTH', blank=True)),
                ('size_breadth', models.CharField(max_length=10, null=True, db_column='SIZE_BREADTH', blank=True)),
                ('ceiling_height', models.CharField(max_length=10, null=True, db_column='CEILING_HEIGHT', blank=True)),
                ...
                ('rentals_current', models.CharField(max_length=10, null=True, db_column='RENTALS_CURRENT', blank=True)),
                ('daily_price_society', models.CharField(max_length=5, null=True, db_column='DAILY_PRICE_SOCIETY', blank=True)),
                ('daily_price_business', models.CharField(max_length=5, null=True, db_column='DAILY_PRICE_BUSINESS', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier_id', models.TextField(null=True, db_column='SUPPLIER_ID', blank=True)),
                ...
                ('contact_landline', models.TextField(null=True, db_column='CONTACT_LANDLINE', blank=True)),
                ('contact_mobile', models.TextField(null=True, db_column='CONTACT_MOBILE', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('door_to_door_price_society', models.CharField(max_length=5, null=True, db_column='DOOR_TO_DOOR_PRICE_SOCIETY', blank=True)),
                ('door_to_door_price_business', models.CharField(max_length=5, null=True, db_column='DOOR_TO_DOOR_PRICE_BUSINESS', blank=True)),
                ('master_door_to_door_flyer_price_society', models.CharField(max_length=5, null=True, db_column='MASTER_DOOR_TO_DOOR_FLYER_PRICE_SOCIETY', blank=True)),
                ('master_door_to_door_flyer_price_business', models.CharField(max_length=5, null=True, db_column='MASTER_DOOR_TO_DOOR_FLYER_PRICE_BUSINESS', blank=True)),
                ...
                ('banner_spaces_count', models.CharField(max_length=255, null=True, db_column='BANNER_SPACES_COUNT', blank=True)),
                ('event_id', models.CharField(max_length=255, null=True, db_column='EVENT_ID', blank=True)),
                ('event_linked', models.CharField(max_length=255, null=True, db_column='EVENT_LINKED', blank=True)),
                ('event_location', models.CharField(max_length=255, null=True, db_column='EVENT_LOCATION', blank=True)),
                ('event_name', models.CharField(max_length=255, null=True, db_column='EVENT_NAME', blank=True)),
                ('event_plan_map', models.CharField(max_length=255, null=True, db_column='EVENT_PLAN_MAP', blank=True)),
                ('event_status', models.CharField(max_length=255, null=True, db_column='EVENT_STATUS', blank=True)),
                ('no_of_days', models.CharField(max_length=255, null=True, db_column='NO_OF_DAYS', blank=True)),
                ('past_gathering_per_event', models.CharField(max_length=255, null=True, db_column='PAST_GATHERING_PER_EVENT', blank=True)),
                ('past_major_events', models.CharField(max_length=255, null=True, db_column='PAST_MAJOR_EVENTS', blank=True)),
                ('poster_spaces_count', models.CharField(max_length=255, null=True, db_column='POSTER_SPACES_COUNT', blank=True)),
                ('stall_spaces_count', models.CharField(max_length=255, null=True, db_column='STALL_SPACES_COUNT', blank=True)),
                ('standee_spaces_count', models.CharField(max_length=255, null=True, db_column='STANDEE_SPACES_COUNT', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mailbox_flyer_price_society', models.CharField(max_length=5, null=True, db_column='MAILBOX_FLYER_PRICE_SOCIETY', blank=True)),
                ('mailbox_flyer_price_business', models.CharField(max_length=5, null=True, db_column='MAILBOX_FLYER_PRICE_BUSINESS', blank=True)),
                ('photograph_1', models.CharField(max_length=45, null=True, db_column='PHOTOGRAPH_1', blank=True)),
                ('photograph_2', models.CharField(max_length=45, null=True, db_column='PHOTOGRAPH_2', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notice_board_size_length', models.CharField(max_length=10, null=True, db_column='NOTICE_BOARD_SIZE_length', blank=True)),
                ('notice_board_size_breadth', models.CharField(max_length=10, null=True, db_column='NOTICE_BOARD_SIZE_BREADTH', blank=True)),
                ('notice_board_size_area', models.CharField(max_length=10, null=True, db_column='NOTICE_BOARD_SIZE_AREA', blank=True)),
                ('photograph_1', models.CharField(max_length=45, null=True, db_column='PHOTOGRAPH_1', blank=True)),
                ('photograph_2', models.CharField(max_length=45, null=True, db_column='PHOTOGRAPH_2', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_id', models.CharField(max_length=10, null=True, db_column='EVENT_ID', blank=True)),
                ('poster_weekly_price_society', models.CharField(max_length=5, null=True, db_column='POSTER_WEEKLY_PRICE_SOCIETY', blank=True)),
                ('poster_monthly_price_society', models.CharField(max_length=5, null=True, db_column='POSTER_MONTHLY_PRICE_SOCIETY', blank=True)),
                ('poster_weekly_price_business', models.CharField(max_length=5, null=True, db_column='POSTER_WEEKLY_PRICE_BUSINESS', blank=True)),
                ('poster_monthly_price_business', models.CharField(max_length=5, null=True, db_column='POSTER_MONTHLY_PRICE_BUSINESS', blank=True)),
                ('stall_linked', models.CharField(max_length=5, null=True, db_column='STALL_LINKED', blank=True)),
                ('stall_id', models.CharField(max_length=20, null=True, db_column='STALL_ID', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flat_size_per_sq_feet_carpet_area', models.CharField(max_length=10, null=True, db_column='FLAT_SIZE_PER_SQ_FEET_CARPET_AREA', blank=True)),
                ('flat_size_per_sq_feet_builtup_area', models.CharField(max_length=10, null=True, db_column='FLAT_SIZE_PER_SQ_FEET_BUILTUP_AREA', blank=True)),
                ('flat_rent', models.CharField(max_length=10, null=True, db_column='FLAT_RENT', blank=True)),
                ('rent_per_sqft', models.CharField(max_length=10, null=True, db_column='RENT_PER_SQFT', blank=True)),
                ('average_rent_pers_sqft_tower', models.CharField(max_length=10, null=True, db_column='AVERAGE_RENT_PERS_SQFT_TOWER', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stall_daily_price_stall_society', models.CharField(max_length=15, null=True, db_column='STALL_DAILY_PRICE_STALL_SOCIETY', blank=True)),
                ('stall_daily_price_stall_business', models.CharField(max_length=15, null=True, db_column='STALL_DAILY_PRICE_STALL_BUSINESS', blank=True)),
                ('current_price_stall', models.CharField(max_length=5, null=True, db_column='Current_Price_Stall', blank=True)),
                ('stall_timings_evening', models.CharField(max_length=10, null=True, db_column='STALL_TIMINGS_evening', blank=True)),
                ...
                ('photograph_1', models.CharField(max_length=45, null=True, db_column='PHOTOGRAPH_1', blank=True)),
                ('photograph_2', models.CharField(max_length=45, null=True, db_column='PHOTOGRAPH_2', blank=True)),
                ('event_id', models.CharField(max_length=45, null=True, db_column='EVENT_ID', blank=True)),
                ('event_linked', models.CharField(max_length=45, null=True, db_column='EVENT_LINKED', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standee_area', models.CharField(max_length=10, null=True, db_column='STANDEE_AREA', blank=True)),
                ...
                ('standee_weekly_price_society', models.CharField(max_length=5, null=True, db_column='STANDEE_WEEKLY_PRICE_SOCIETY', blank=True)),
                ('standee_monthly_price_society', models.CharField(max_length=5, null=True, db_column='STANDEE_MONTHLY_PRICE_SOCIETY', blank=True)),
                ('standee_weekly_price_business', models.CharField(max_length=5, null=True, db_column='STANDEE_WEEKLY_PRICE_BUSINESS', blank=True)),
                ('standee_monthly_price_business', models.CharField(max_length=5, null=True, db_column='STANDEE_MONTHLY_PRICE_BUSINESS', blank=True)),
                ...
                ('event_linked', models.CharField(max_length=5, null=True, db_column='EVENT_LINKED', blank=True)),
                ('stall_linked', models.CharField(max_length=5, null=True, db_column='STALL_LINKED', blank=True)),
                ('stall_id', models.CharField(max_length=45, null=True, db_column='STALL_ID', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('society_zip', models.CharField(max_length=250, null=True, db_column='SOCIETY_ZIP', blank=True)),
                ...
                ('society_longitude', models.CharField(max_length=20, null=True, db_column='SOCIETY_LONGITUDE', blank=True)),
                ('society_latitude', models.CharField(max_length=20, null=True, db_column='SOCIETY_LATITUDE', blank=True)),
                ...
                ('notice_board_available', models.TextField(null=True, db_column='NOTICE_BOARD_AVAILABLE', blank=True)),
                ('stall_available', models.TextField(null=True, db_column='STALL_AVAILABLE', blank=True)),
                ('car_display_available', models.TextField(null=True, db_column='CAR_DISPLAY_AVAILABLE', blank=True)),
                ('banner_available', models.TextField(null=True, db_column='BANNER_AVAILABLE', blank=True)),
                ('food_tasting_allowed', models.CharField(max_length=5, null=True, db_column='FOOD_TASTING_ALLOWED', blank=True)),
                ('events_count', models.IntegerField(null=True, db_column='EVENTS_COUNT', blank=True)),
                ('swimming_pool_avaialblity', models.TextField(null=True, db_column='SWIMMING_POOL_AVAIALBLITY', blank=True)),
                ('mail_box_available', models.TextField(null=True, db_column='MAIL_BOX_AVAILABLE', blank=True)),
                ('door_to_door_allowed', models.TextField(null=True, db_column='DOOR_TO_DOOR_ALLOWED', blank=True)),
                ('events_occurance', models.CharField(max_length=5, null=True, db_column='EVENTS_OCCURANCE', blank=True)),
                ('street_furniture_available', models.TextField(null=True, db_column='STREET_FURNITURE_AVAILABLE', blank=True)),
                ('sports_facility_available', models.CharField(max_length=5, null=True, db_column='SPORTS_FACILITY_AVAILABLE', blank=True)),
                ('swimming_pool_availabel', models.TextField(null=True, db_column='SWIMMING_POOL_AVAILABEL', blank=True)),
                ('street_furniture_count', models.IntegerField(null=True, db_column='STREET_FURNITURE_COUNT', blank=True)),
                ...
                ('past_year_collections_stalls', models.IntegerField(null=True, db_column='PAST_YEAR_COLLECTIONS_STALLS', blank=True)),
                ('past_year_collections_car', models.IntegerField(null=True, db_column='PAST_YEAR_COLLECTIONS_CAR', blank=True)),
                ('past_year_collections_poster', models.IntegerField(null=True, db_column='PAST_YEAR_COLLECTIONS_POSTER', blank=True)),
                ('past_year_collections_banners', models.IntegerField(null=True, db_column='PAST_YEAR_COLLECTIONS_BANNERS', blank=True)),
                ('past_year_collections_standee', models.IntegerField(null=True, db_column='PAST_YEAR_COLLECTIONS_STANDEE', blank=True)),
                ('past_year_sponsorship_collection_events', models.IntegerField(null=True, db_column='PAST_YEAR_SPONSORSHIP_COLLECTION_EVENTS', blank=True)),
                ('past_year_total_sponsorship', models.IntegerField(null=True, db_column='PAST_YEAR_TOTAL_SPONSORSHIP', blank=True)),
                ('societies_preferred_business_type', models.CharField(max_length=50, null=True, db_column='SOCIETIES_PREFERRED_BUSINESS_TYPE', blank=True)),
                ('societies_preferred_business_id', models.CharField(max_length=50, null=True, db_column='SOCIETIES_PREFERRED_BUSINESS_ID', blank=True)),
                ...
                ('poster_count', models.IntegerField(null=True, db_column='POSTER_COUNT', blank=True)),
                ('banner_count', models.IntegerField(null=True, db_column='BANNER_COUNT', blank=True)),
                ('wall_count', models.IntegerField(null=True, db_column='WALL_COUNT', blank=True)),
                ('flier_distribution_frequency_per_month', models.IntegerField(null=True, db_column='FLIER_DISTRIBUTION_FREQUENCY_PER_MONTH', blank=True)),
                ('bill_sponsorship_electricity', models.CharField(max_length=20, null=True, db_column='BILL_SPONSORSHIP_ELECTRICITY', blank=True)),
                ('bill_sponsorship_maintenanace', models.CharField(max_length=20, null=True, db_column='BILL_SPONSORSHIP_MAINTENANACE', blank=True)),
                ('children_playing_area_available', models.CharField(max_length=45, null=True, db_column='CHILDREN_PLAYING_AREA_AVAILABLE', blank=True)),
                ('children_playing_area_count', models.IntegerField(null=True, db_column='CHILDREN_PLAYING_AREA_count', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size_breadth', models.CharField(max_length=10, null=True, db_column='SIZE_BREADTH', blank=True)),
                ('size_length', models.CharField(max_length=10, null=True, db_column='SIZE_LENGTH', blank=True)),
                ('side_area', models.CharField(max_length=10, null=True, db_column='SIDE_AREA', blank=True)),
                ('side_rentals', models.CharField(max_length=10, null=True, db_column='SIDE_RENTALS', blank=True)),
                ('timings_open', models.CharField(max_length=20, null=True, db_column='TIMINGS_OPEN', blank=True)),
                ('timings_close', models.CharField(max_length=20, null=True, db_column='TIMINGS_CLOSE', blank=True)),
                ('daily_price_society', models.CharField(max_length=5, null=True, db_column='DAILY_PRICE_SOCIETY', blank=True)),
                ('daily_price_business', models.CharField(max_length=5, null=True, db_column='DAILY_PRICE_BUSINESS', blank=True)),
                ('location', models.CharField(max_length=50, null=True, db_column='LOCATION', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wall_monthly_price_society', models.CharField(max_length=5, null=True, db_column='WALL_MONTHLY_PRICE_SOCIETY', blank=True)),
                ('wall_quarterly_price_society', models.CharField(max_length=5, null=True, db_column='WALL_QUARTERLY_PRICE_SOCIETY', blank=True)),
                ('wall_monthly_price_business', models.CharField(max_length=5, null=True, db_column='WALL_MONTHLY_PRICE_BUSINESS', blank=True)),
                ('wall_quarterly_price_business', models.CharField(max_length=5, null=True, db_column='WALL_QUARTERLY_PRICE_BUSINESS', blank=True)),
