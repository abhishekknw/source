    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proposal', models.ForeignKey(related_name='proposals_version', db_column='PROPOSAL', to='v0.ProposalInfo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salon_count', models.IntegerField(default=0)),
                ('salon_buffer_count', models.IntegerField(default=0)),
                ('center', models.OneToOneField(related_name='space_mappings_version', to='v0.ProposalCenterMappingVersion')),
                ('proposal', models.ForeignKey(related_name='space_mapping_version', to='v0.ProposalInfoVersion')),
            ],
            options={
