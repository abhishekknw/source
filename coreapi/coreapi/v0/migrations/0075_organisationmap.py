    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_organisation', models.ForeignKey(related_name='first_organisation', to='v0.Organisation')),
                ('second_organisation', models.ForeignKey(related_name='second_organisation', to='v0.Organisation')),
            ],
            options={
