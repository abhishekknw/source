...
.controller('SocietyCtrl',
    ...
    function ($scope, $rootScope, $window, $location, societyDetailsService) {
     ...
     societyDetailsService.getSociety($rootScope.societyId)
      ...
      //Start : Added function to slide multiple images

      //End : Added function to slide multiple images

      console.log($scope.SocietyImages,$scope.StandeeImages,$scope.StallImages,$scope.FlierImages,$scope.CarImages,$scope.PosterImages);
